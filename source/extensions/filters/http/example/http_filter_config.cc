...
#include "source/extensions/filters/http/example/http_filter.pb.h"
#include "source/extensions/filters/http/example/http_filter.pb.validate.h"

#include "extensions/filters/http/example/http_filter.h"
...
public:
  ...
  std::string name() override { return Extensions::HttpFilters::HttpFilterNames::get().Example; }
...
private:
  ...
  void translateHttpSampleDecoderFilter(const Json::Object& json_config,
    ...
    // normally we want to validate the json_config against a defined json-schema here.
