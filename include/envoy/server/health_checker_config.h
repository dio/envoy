...
public:
  ...
  /**
   * Creates a particular upstream custom health checker factory implementation.
   *
   ...
   * @return Upstream::HealthCheckerSharedPtr the pointer of a health checker instance.
   */
